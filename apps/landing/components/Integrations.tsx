...
export function Integrations() {
  return (
    <section id="integrations" style={{ padding: '96px 24px', maxWidth: 1200, margin: '0 auto' }}>
      ...
      <p style={{ color: 'var(--color-text-muted)', fontSize: 18, maxWidth: 720, marginBottom: 48 }}>
            ...
            <Card key={p.name} variant="outlined" style={{ background: 'var(--color-bg-elev)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div style={{ minWidth: 0 }}>
                  ...
                  {codenamed && (
                    <div className="mono" style={{ fontSize: 12, color: 'var(--color-text-muted)', lineHeight: 1.3, wordBreak: 'break-word' }}>
                      {p.realName}
                    </div>
                  )}
