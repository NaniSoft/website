...
interface ScrollProgressBarProps {
  height?: number // Bar height in px, defaults to 3
  colors?: string[] // Gradient color stops, defaults to a rainbow gradient
  zIndex?: number // z-index stack level, defaults to 9999
  smoothness?: number // Smoothing factor (0-1), defaults to 0.15 — lower is smoother but less responsive
}
...
export default function ScrollProgressBar({
  ...
  const animateProgress = useCallback(() => {
    ...
    // Stop animating once the difference is tiny and scrolling has been idle for 200ms
    ...
    >
      <div
        ...
        style={{
          ...
          willChange: 'width',
          // We keep animating width (rather than transform) because we need
          // an accurate progress indicator.
        }}
      />
    </div>
  )
