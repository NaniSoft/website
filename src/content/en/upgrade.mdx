...
- 🌍 **Localized Demo Copy**: AI Demo copy is managed through `src/i18n/ai-demo.ts` and reuses `src/i18n/en.ts`, making it easier to replace with real product messaging.
...
- 🧪 **Project Distillation Skill**: Added the [English Skill](https://github.com/pdsuwwz/nextjs-nextra-starter/blob/main/.agents/skills/nextjs-nextra-starter-distill/SKILL.md) to capture the architecture, feature map, implementation patterns, extension points, and migration notes for future projects.
