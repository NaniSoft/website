...
Nextra supports multilingual content through folder structure. In the project root directory, you can create a folder for each language, such as:
...
The current language is read automatically from the URL parameter (e.g., [`/en/introduction`](/en/introduction)).
